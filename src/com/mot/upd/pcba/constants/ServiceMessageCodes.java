...
public class ServiceMessageCodes {
	...
	public static final String INPUT_PARAM_MISSING_MSG = "Following Fields are mandatory- Build type,Request-type,RSD id,MASC ID.Please re-enter and try again.";
